...
public class MapaTest {
	public static void main(String[] args) {
		...
		**/ListaGenerica<String> lis3 = m.caminoMasCorto2("Buenos Aires","Asuncion");
		...
		**/
		...
		ListaGenerica<String> lis6 = m.caminoConMenorCargaDeCombustible2("Buenos Aires","Asuncion",8);
		//PARA COMPROBAR QUE FUNCIONA CAMBIAR ciudades.conectar(v1, v2,8); Y ciudades.conectar(v2, v5,8);
		System.out.println("--- Se imprime caminoConMenorCargaDeCombustible ---");
		lis6.comenzar();
		while(!lis6.fin()) {
